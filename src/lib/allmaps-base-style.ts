...
export function allmapsBasemapStyle(
  lang = 'en',
  tileJson = 'https://api.protomaps.com/tiles/v4.json?key=ca7652ec836f269a'
): StyleSpecification {
  const layers = basemapLayers('protomaps', ALLMAPS_FLAVOR, { lang }).filter(
